...
export function DocumentVariants({title = "Document", variant }: { title?: string; variant: string}) {
    ...
    const getContent = (): React.ReactNode => {
      ...
      if (variant === "simple") return <SimpleContent />
    }
    return (
    ...
    <div>
      ...
      <DummyParagraph
        items={[
          ...
          <DummyParagraph
            items={[
              <div style={{ width: "var(--circle-size)", height: "var(--circle-size)", borderRadius: "999px", background: "var(--circle-background)", flexShrink: 0 }} />,
              <DummyLine width="100%" height="var(--line-height)" />,
            ]}
            direction="row"
            alignItems="center"
...
function ImageContent() {
  return (
    <div>
      ...
      <DummyParagraph
        items={[
          <div style={{ width: "40%", height: "18px", borderRadius: "var(--image-radius)", background: "var(--circle-background)", flexShrink: 0 }} />,
  ...
  return (
    <div>
      <DummyParagraph
        ...
        gap="var(--gap)"
      />
      <div className="flex flex-col gap-0" style={{ width: "100%", borderRadius: "var(--image-radius)", border: "1px solid var(--dummy-background)", flexShrink: 0 }}>
        <div className="h-full" style={{ width: "100%", height: "4px", background: "var(--dummy-background)", flexShrink: 0 }} />
        <div className="flex flex-row gap-0" style={{ height: "fit-content"}}>
          <div className="h-full w-3/4 flex flex-col justify-center p-1" style={{ borderRight: "1px solid var(--dummy-background)"}}>
            <DummyParagraph
              items={[
